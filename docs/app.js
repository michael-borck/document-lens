...
// 2. Builds the screenshot carousel by probing screenshots/document-lens-1.png,
...
const REPO = 'michael-borck/document-lens'
...
const SHOT_PREFIX = 'screenshots/document-lens-'
...
function buildCarousel(urls) {
  ...
  urls.forEach((url, i) => {
    ...
    img.src = url
    img.alt = `Document Lens screenshot ${i + 1}`
